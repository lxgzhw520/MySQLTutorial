...
insert into `departments`(`department_id`, #部门编号
...
(
  ...
  `first_name`     varchar(20)   DEFAULT NULL,#名
  `last_name`      varchar(25)   DEFAULT NULL,#姓
  ...
  `manager_id`     int(6)        DEFAULT NULL,#上级领导的员工编号
...
(
  ...
  `state_province` varchar(25) DEFAULT NULL,#州/省
  `country_id`     varchar(2)  DEFAULT NULL,#国家编号
